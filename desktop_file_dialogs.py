...
class Desktop_FolderDialog(Desktop_FileDialog_Base):
  ...
  def __init__(self,
    ...
    super(Desktop_FolderDialog,self).__init__(
...
class Desktop_FileDialog(Desktop_FileDialog_Base):
    ...
    def __init__(self,
        ...
        super(Desktop_FileDialog,self).__init__(
...
class Desktop_FilesDialog(Desktop_FileDialog_Base):
  ...
  def __init__(self,
    ...
    super(Desktop_FilesDialog,self).__init__(
...
class Desktop_SaveFile_Dialog(Desktop_FileDialog_Base):
  ...
  def __init__(self,
    ...
    super(Desktop_SaveFile_Dialog,self).__init__(
